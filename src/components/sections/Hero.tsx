...
export function Hero() {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-black select-none">
      {/* ── BACKGROUND SLIDES (100% WIDTH ASPECT RATIO RESPONSIVE) ────── */}
      ...
      {/* ── SLIDE 1 OVERLAY TEXT (ONLY ON SLIDE 1) ────────────────────── */}
      <AnimatePresence mode="wait">
        {currentImage.hasOverlayText && (
          <motion.div
            key="slide1-text"
          ...
          >
            ...
            <motion.p
              ...
              className="mt-4 sm:mt-6 md:mt-8 text-white/80 font-sans tracking-[0.35em] uppercase text-[9px] sm:text-xs md:text-sm"
            >
